...
const admissionStatusBorders: Record<string, string> = {
  ACTIVE: "border-l-[#4AF626]",
  DISCHARGED: "border-l-[#555555]",
  CANCELLED: "border-l-[#E61919]",
};
  ...
  const exportPdf = () => {
    ...
    autoTable(doc, {
      ...
      body: admissions.map((a) => [
        ...
        a.predictedDischargeDate
          ? new Date(a.predictedDischargeDate).toLocaleDateString("pt-BR")
          : "—",
        a.dischargeDate
          ? new Date(a.dischargeDate).toLocaleDateString("pt-BR")
          : "—",
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className={formStyles.header.subtitle}>
                REGISTROS DE INTERNAMENTO DE PACIENTES
              </p>
            </div>
          </div>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
              <DialogTrigger render={<Button />}>
                <span className={formStyles.button.trigger}>
                  <HiPlus className="h-3.5 w-3.5" /> NOVO INTERNAMENTO
                </span>
              </DialogTrigger>
              <DialogContent className={formStyles.dialog.content}>
                ...
                >
                  ...
                  <div className={formStyles.field.wrapper}>
                    <Label className={formStyles.field.label}>&gt; LEITO</Label>
                    <select
                      {...register("bedId")}
                      className={formStyles.field.select}
                    >
                  ...
                  <div className={formStyles.field.wrapper}>
                    ...
                    <Input
                      type="date"
                      {...register("predictedDischargeDate")}
                      className={formStyles.field.input}
                    />
                  </div>
                  <div className={formStyles.field.wrapper}>
            ...
            <TableBody>
              {admissions.map((a) => (
                <TableRow key={a.id} className={formStyles.table.bodyRow}>
                  ...
                  <TableCell className={formStyles.table.cell}>
                    {a.predictedDischargeDate
                      ? new Date(a.predictedDischargeDate).toLocaleDateString(
                          "pt-BR",
                        )
                      : "—"}
                  </TableCell>
